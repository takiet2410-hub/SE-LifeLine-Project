...
During the project, I was mainly responsible for the roles of Business Analyst, Quality Assurance, and Frontend Developer. As a BA and Frontend Developer, my main contributions included analyzing system requirements to define clear business rules, and building responsive, user-friendly frontend interfaces that enhanced the overall user experience. Furthermore, I spearheaded the QA process by designing functional test cases and authoring both the Test Plan and the detailed Test Execution & Bug Reports. One contribution that I consider particularly significant was establishing a comprehensive testing and defect management pipeline. Through this process, I systematically identified, tracked, and verified the resolution of critical system defects across multiple modules. This was vital to the project because it not only significantly elevated our final test pass rate, but also guaranteed the stability and reliability of core workflows - such as Donor Booking, Campaign Management, and the AI Chatbot - ensuring a seamless and error-free deployment.
