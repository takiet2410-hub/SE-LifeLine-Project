...
### 5.3 Trần Đức Quý - 24127526 - Role: Full-stack Developer

During the project, I was mainly responsible for developing the Notification system, SOS Emergency workflows, News Feed, Administrator features, and the Blood Center UI. My main contributions included building the full-stack architecture for real-time alerts, managing emergency blood requests, and designing an intuitive dashboard for blood center staff and admins. One contribution that I consider particularly significant was implementing the SOS request and notification integration, because it ensures that life-saving emergency alerts are immediately broadcasted to eligible donors, directly supporting the core mission of LifeLine. The main challenges I faced involved managing state synchronization for real-time notifications and ensuring strict role-based access control across the Admin and Blood Center interfaces. This project greatly enhanced my proficiency in full-stack web development, particularly in building scalable backend services and crafting responsive user interfaces with React.

### 5.4 Trần Minh Triết - 24127573 - Role: Frontend Lead, Full-stack Developer
Throughout this project, I was responsible for developing the Blood Center side of the system, including both frontend and backend implementation for Campaign Management, Campaign Registration, Content Management, and Blood Inventory Management. I also prepared UI prototypes for the Blood Center interface, wrote Use Case Specifications, and supported the team in fixing bugs across the web application. One of the main challenges I faced was designing a suitable and user-friendly UI while ensuring consistency between the frontend and backend. In addition, working with AI-generated code was initially difficult because I was not yet familiar with controlling and organizing AI-assisted code, which sometimes resulted in an inconsistent project structure. Through this project, I learned the importance of carefully reviewing AI-generated code, maintaining a clear code structure, and analyzing UI and system requirements thoroughly before implementation.

### 5.5 Trịnh Khánh Linh - 24127437 - Role: BA, QA, Frontend Developer

During the project, I was mainly responsible for the roles of Business Analyst, Quality Assurance, and Frontend Developer. As a Frontend Developer, my main contributions included building the entire initial user interface for the Donor actor, ensuring a responsive and user-friendly experience. For the QA role, I spearheaded the testing process by authoring all three core testing documents: the Test Plan, Test Cases, and the detailed Test Execution & Bug Reports. One contribution that I consider particularly significant was establishing a comprehensive testing and defect management pipeline, which systematically identified and verified the resolution of critical system defects across core workflows. The main challenge I faced was designing comprehensive test cases that could cover all possible edge cases for our complex, interconnected workflows. Overcoming this challenge required a deep dive into the system's business rules and adopting a highly structured approach to quality assurance, which significantly sharpened my analytical and testing skills.
