  ...
  if (!data.date || !data.locationId) {
    return (
      <div className="flex flex-col items-center justify-center py-20 text-center">
        <p className="text-[14px] text-[#6c757d] mb-4">Thông tin chưa đầy đủ. Vui lòng thực hiện lại từ đầu.</p>
        <button
  ...
  return (
    <div className="flex flex-col gap-6 max-w-[800px] mx-auto">
      ...
      <div className="bg-[#fff8f7] border border-[#f1f3f5] rounded-xl p-6 shadow-sm text-center">
        ...
        <h2 className="text-[20px] font-bold text-[#271816] mb-1">Sắp hoàn thành!</h2>
        <p className="text-[14px] text-[#5b403d]">Vui lòng kiểm tra lại thông tin đặt lịch trước khi xác nhận.</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-white border border-[#f1f3f5] rounded-xl shadow-sm overflow-hidden">
          <div className="bg-[#f8f9fa] border-b border-[#f1f3f5] px-5 py-4">
            <h3 className="text-[14px] font-bold text-[#271816]">Ngày & Giờ Hiến Máu</h3>
          </div>
          <div className="p-5 flex flex-col gap-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-[12px] text-[#6c757d] uppercase font-bold tracking-wide">Ngày hẹn</p>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-[12px] text-[#6c757d] uppercase font-bold tracking-wide">Khung giờ</p>
        ...
        <div className="bg-white border border-[#f1f3f5] rounded-xl shadow-sm overflow-hidden">
          <div className="bg-[#f8f9fa] border-b border-[#f1f3f5] px-5 py-4">
            <h3 className="text-[14px] font-bold text-[#271816]">Địa Điểm Tiếp Nhận</h3>
          </div>
      ...
      <div className="bg-white border border-[#f1f3f5] rounded-xl shadow-sm p-6 flex items-start gap-4">
        ...
        <div>
          <h3 className="text-[15px] font-bold text-[#271816] mb-1">Kết quả khảo sát sức khỏe</h3>
          {hasRiskyAnswers ? (
            <p className="text-[13px] text-amber-700 font-medium">
              Bạn có trả lời CÓ ở một số câu hỏi sàng lọc. Bác sĩ chuyên môn sẽ thăm khám và tư vấn trực tiếp trước khi hiến máu.
            </p>
          ) : (
            <p className="text-[13px] text-[#6c757d]">
              Tất cả câu hỏi sàng lọc đều hợp lệ. Hãy duy trì chế độ dinh dưỡng và nghỉ ngơi hợp lý trước ngày hẹn.
            </p>
          )}
        </div>
      </div>
