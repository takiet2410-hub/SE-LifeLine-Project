...
export const RegistrationDetailPage: React.FC = () => {
  ...
  return (
    <div className="space-y-6 max-w-6xl mx-auto">
        ...
        <div className="flex items-center gap-2 shrink-0 self-end md:self-center">
          ...
          {registration.status === 'CheckedIn' && (
            <>
              ...
              <button
                type="button"
                onClick={() => handleUpdateStatus('Ineligible')}
                className="px-4 py-2 bg-red-600 hover:bg-red-700 text-white text-[12px] font-bold rounded-xl flex items-center gap-1.5 shadow-2xs transition-all cursor-pointer whitespace-nowrap"
              >
                <XCircle className="w-4 h-4 text-white" />
      ...
      {/* Main Container: Full Width when not CheckedIn, 2-Column Grid when CheckedIn or later */}
      {!isCheckedInOrLater ? (
        ...
        <div className="space-y-6 w-full">
          ...
          <div className="bg-white border border-[#f1f3f5] rounded-2xl p-6 md:p-8 shadow-2xs space-y-5 w-full">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 text-[13px] pt-1">
              ...
              <div className="p-3 bg-slate-50/70 rounded-xl border border-slate-200 space-y-1">
                ...
                <p className="text-[#271816] font-semibold text-[14px]">{registration.donorDob || '15/08/1995'}</p>
              </div>
          ...
          {/* Card 2: Donor Pre-screening Self-Report (Screening Survey Form) */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          {/* Right Column: Clinical Vitals Form & Donation History Table (8 cols) */}
