...
// Mock location data with realistic HCM hospital locations if backend returned items have no lat/lng
const HCMC_DONATION_CENTERS = [
  {
    id: 'CR-001',
    ...
    bloodTypes: ['A+', 'O+', 'B-', 'AB+'],
    operatingHours: '07:00 - 16:30 (Thứ 2 - Thứ 7)',
    timeSlots: [
      { startTime: '07:30', endTime: '09:00', capacity: 15, registeredCount: 8 },
      { startTime: '09:00', endTime: '10:30', capacity: 15, registeredCount: 12 },
      { startTime: '10:30', endTime: '12:00', capacity: 15, registeredCount: 5 },
      { startTime: '13:30', endTime: '15:00', capacity: 15, registeredCount: 4 },
    ],
  },
  {
    id: 'TM-002',
    ...
    status: 'Active Now' as const,
    bloodTypes: ['O-', 'A-', 'B+', 'AB-'],
    operatingHours: '07:00 - 17:00 (Hàng ngày)',
    timeSlots: [
      { startTime: '08:00', endTime: '09:30', capacity: 20, registeredCount: 6 },
      { startTime: '09:30', endTime: '11:00', capacity: 20, registeredCount: 9 },
      { startTime: '13:00', endTime: '14:30', capacity: 20, registeredCount: 3 },
    ],
  },
  {
    id: 'D10-005',
    name: 'Bệnh viện Đa khoa Quận 10',
    address: '571 Sư Vạn Hạnh, Phường 13, Quận 10, TP. Hồ Chí Minh',
    lat: 10.7712,
    lng: 106.6698,
    rating: 4.6,
    crowdingLevel: 'Moderate' as const,
    status: 'Active Now' as const,
    bloodTypes: ['A+', 'B+', 'O+'],
    operatingHours: '07:30 - 16:30 (Thứ 2 - Thứ 6)',
    timeSlots: [
      { startTime: '08:00', endTime: '09:30', capacity: 15, registeredCount: 5 },
      { startTime: '09:30', endTime: '11:00', capacity: 15, registeredCount: 7 },
    ],
  },
  {
    id: 'TD-003',
    ...
    lng: 106.6853,
    rating: 4.7,
    crowdingLevel: 'High' as const,
    status: 'Urgent' as const,
    bloodTypes: ['O+', 'B+'],
    operatingHours: '07:30 - 16:00 (Thứ 2 - Thứ 6)',
    timeSlots: [
      { startTime: '08:00', endTime: '10:00', capacity: 12, registeredCount: 12 },
      { startTime: '10:00', endTime: '12:00', capacity: 12, registeredCount: 11 },
      { startTime: '13:30', endTime: '15:30', capacity: 12, registeredCount: 10 },
    ],
  },
  {
    id: 'TN-006',
    ...
    timeSlots: [
      { startTime: '07:30', endTime: '09:00', capacity: 20, registeredCount: 4 },
      { startTime: '09:00', endTime: '10:30', capacity: 20, registeredCount: 6 },
    ],
  },
  {
    id: 'RC-004',
    name: 'Trung tâm Hiến máu Nhân đạo TP.HCM',
    address: '106 Nguyễn Thị Minh Khai, Phường 6, Quận 3, TP. Hồ Chí Minh',
    lat: 10.7762,
    lng: 106.6917,
    rating: 4.9,
    crowdingLevel: 'Low' as const,
    ...
    operatingHours: '07:00 - 11:30 (Thứ 2 - Chủ Nhật)',
    timeSlots: [
      { startTime: '07:00', endTime: '09:00', capacity: 25, registeredCount: 10 },
      { startTime: '09:00', endTime: '11:00', capacity: 25, registeredCount: 14 },
    ],
  },
  {
    id: 'GD-007',
    ...
    timeSlots: [
      { startTime: '08:00', endTime: '10:00', capacity: 15, registeredCount: 13 },
    ],
  },
  {
    id: 'QY-008',
    name: 'Bệnh viện Quân Y 175',
    address: '786 Nguyễn Kiệm, Phường 3, Gò Vấp, TP. Hồ Chí Minh',
    lat: 10.8175,
    lng: 106.6782,
    rating: 4.9,
    crowdingLevel: 'Moderate' as const,
    ...
    timeSlots: [
      { startTime: '07:30', endTime: '09:30', capacity: 30, registeredCount: 15 },
    ],
  },
  {
    id: 'TD-009',
    name: 'Bệnh viện Thành phố Thủ Đức',
    address: '29 Phú Châu, Tam Phú, Thủ Đức, TP. Hồ Chí Minh',
    lat: 10.8525,
    lng: 106.7584,
    rating: 4.6,
    crowdingLevel: 'Low' as const,
    ...
    timeSlots: [
      { startTime: '08:00', endTime: '10:00', capacity: 20, registeredCount: 5 },
    ],
  },
  {
    id: 'CC-010',
    name: 'Bệnh viện Đa khoa Khu vực Củ Chi',
    address: 'Tỉnh lộ 8, Xã Tân An Hội, Củ Chi, TP. Hồ Chí Minh',
    lat: 10.9782,
    lng: 106.4912,
    rating: 4.5,
    crowdingLevel: 'Low' as const,
    ...
    timeSlots: [
      { startTime: '08:00', endTime: '11:00', capacity: 20, registeredCount: 3 },
    ],
  },
];
...
export const InteractiveMapPage: React.FC = () => {
  ...
  const getDisplayDistanceKm = (lat: number, lng: number) => {
    return getDistanceNum(lat, lng).toFixed(1);
  };
